...
MANUALS = [
    dict(out=P("docs", "pdf", "Narrow-Gauge-User-Manual.pdf"),
         title="FUSE Narrow Gauge User Manual",
         subtitle="Narrow-gauge and dual-gauge track for Railroader",
         sections=[("Getting Started", P("docs","GETTING_STARTED.md")),
                   ("Authoring Guide", P("docs","AUTHORING.md")),
                   ("Special-Work Catalog", P("docs","special-work-catalog.md"))]),
]
